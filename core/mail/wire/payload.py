"""
BGM Mail Wire Payload
Black Gold Messenger

JSON + Base64 representation for encrypted mail payloads.
"""
...
MAIL_WIRE_PROTOCOL_VERSION = "0.1"


@dataclass(frozen=True)
class BGMMailWirePayload:
    """Serializable encrypted mail payload."""

    ciphertext: bytes
    nonce: bytes
    key_id: str
    protocol_version: str = MAIL_WIRE_PROTOCOL_VERSION
...
def encode_wire_payload(
    ...
    """Encode an encrypted mail payload as JSON with Base64 binary fields."""
...
def decode_wire_payload(
    ...
    """Decode a JSON + Base64 encrypted mail payload."""
